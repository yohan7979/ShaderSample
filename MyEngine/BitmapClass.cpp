...
bool BitmapClass::CreateVertexBuffer(ID3D11Device * device, void* vertices, int vertexCount)
{
	HRESULT result;
...
bool BitmapClass::CreateIndexBuffer(ID3D11Device * device, unsigned long* indices, int indexCount)
{
	HRESULT result;
